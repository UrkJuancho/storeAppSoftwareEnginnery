    ...
    <div className='bg-half-transparent w-screen fixed nav-item top-0 right-0'>
      <div className='float-right h-screen dark:text-gray-600 bg-white dark:[#484852] w-400'>
        <div className='flex justify-between items-center p-4 ml-4'>
          <p className='font-semibold text-xl'>Configuracion de Apariencia</p>
          <button
            type='button'
        ...
        <div className='flex-col border-t-1 border-color p-4 ml-4'>
          <p className='font-semibold text-lg'>Apariencia</p>
          <div className='mt-4'>
            <input
              type='radio'
              id='light'
        ...
        <div className='p-4 border-t-1 border-color ml-4'>
          <p className='font-semibold text-xl'>Temas personales detallados</p>
